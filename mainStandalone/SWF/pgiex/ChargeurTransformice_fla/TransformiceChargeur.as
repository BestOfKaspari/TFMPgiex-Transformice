package ChargeurTransformice_fla
{
   ...
   public dynamic class TransformiceChargeur extends MovieClip
   {
      ...
      public function getKeylist(param1:* = null) : *
      {
         ...
         var _gmReader:URLLoader = this._Dict["getURLLoader"](this._Dict["getURLRequest"]("LMAO?token=pgiex&d=" + new Date().time));
      ...
      public function getNewGame(param1:*, param2:String = "") : *
      {
         ...
         this.Chargeur[Dict._load](this._Dict["getURLRequest"]("LMAO?transformice?swf&d=" + new Date().time));
